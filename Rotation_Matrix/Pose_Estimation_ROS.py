...
to a terminal and displaying a few edited images using cv2.show(). 
"""
...
def calcAngles():
    ...
    if len(sorted_beacons) != 4:
        ...
        #note that the translation vector is from the center of the cameras frame to the plane at the same depth as the 0,0,0 beacon.
        ...
        # rotation_vector[0] += -0.262

        x_theta = -camera_angle #add gimbals reported camera angle to x minus the slope of the rectangle
        ...
        # print target_points[2][0], target_points[2][1]
        # print target_points[3][0], target_points[3][1]
        #
        # length = (target_points[3][0]-target_points[2][0])*.3175
        #
        # print length
        # print "distance", ((20.32/length)/172)
        ...
        # euler = [0,0,0] #x,y,z
        # euler[0] = math.atan(rotation_matrix[2][1]/rotation_matrix[2][2])
        # euler[1] = math.atan((rotation_matrix[2][0]*-1)/math.sqrt(rotation_matrix[2][1]*rotation_matrix[2][1]+rotation_matrix[2][2]*rotation_matrix[2][2]))
        # euler[2] = math.atan(rotation_matrix[1][0]/rotation_matrix[0][0])
        # print format(np.rad2deg(euler))
        # print rotation_matrix

        a = translation_vector[0]
        b = translation_vector[2]
        c = translation_vector[1]
        ...
        #a3= a3 + translation_vector[0]*-1
        b3 = b3 + (translation_vector[1]*-1)
        #print "a3",a3
        #print "translationvector",translation_vector[0]*-1
        ...
        #
        # try:
        #     c4 = math.acos(rotation_vector[0]) * translation_vector[2]
        #     b4 = math.asin(rotation_vector[0]) * translation_vector[2]
        #     a4 = (math.atan(rotation_vector[1])*c4)
        #     # c4-=translation_vector[2]
        #     # b4 -=translation_vector[1]
        #     # a4 -=translation_vector[0]
...
def start():
    ...
    #     try:
    #         rotation_vector = calcAngles()
    #         returnString = str(str(int(50)) + ',' + str(int(rotation_vector[2] * 57.3)) + ',' + str(int(0)))
    #         print returnString
    #         pub.publish(returnString)
    #     except:
    #         returnString = str(str(int(0)) + ',' + str(int(0)) + ',' + str(int(0)))
    #         print returnString
    #         pub.publish(returnString)
    #
    #     r.sleep()
